<aside class="matriculAsilef">
    ...
    <ul>
        ...
        <li><a href="matriPadres.html"><i class="fa fa-user-friends"></i>Padres</a></li>
        ...
        <li><a href="acercaNoso.html"><i class="fa fa-home"></i>Acerca de Nosotros</a></li>
    </ul>
</aside>
<section class="Matri-cuerpo">
    <div class="content1">
        <h2>Datos del Estudiante</h2>
        <form id="m-e" method="POST">
            <div class="nombre">
            ...
            <div class="apellidoM">
                <label>Apellido Paterno: <input type="text" name="appellido_m" ></label>
            </div>
            <div class="dniNacimi">
            ...
            <div class="gradoEstu">
                <label>Grado de Estudio: <input type="number" name="grado" ></label>
            </div>
            ...
            <input type="hidden" name="accion" value="m-estudiante">
            <div class="btn">
